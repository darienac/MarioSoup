...
namespace Tiles {
    enum {
        ...
        UIPREVIEWBOX_MASK, UIPREVIEWBOX_OUTLINE,

        COIN_ICO, TITLE,

        BACKGROUND_OVERWORLD1_SMA4, BACKGROUND_CLOUDS1_SMA4,
    ...
    void initTiles() {
        ...
        initTileGrid(tiles + UIPREVIEWBOX_MASK, UI, 96, 32, 32, 32, 0, 0, 2, 2);
        ...
        tiles[BACKGROUND_CLOUDS1_SMA4] = Tile(SMA4_BACKGROUNDS, 1544, 1423, 256, 216);
